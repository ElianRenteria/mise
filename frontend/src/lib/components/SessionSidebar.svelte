				...
				{#each sessions as session (session.id)}
					...
					>
						...
						<button
							...
							class="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-lg bg-surface-200 hover:bg-error-100 text-surface-500 hover:text-error-500 transition-all disabled:opacity-50 opacity-100 md:opacity-0 md:group-hover:opacity-100"
